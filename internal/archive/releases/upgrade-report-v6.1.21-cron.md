...
```
执行命令：node ~/.jvs/.openclaw/workspace/claude-heartflow-skill/scripts/personality-check.js before
...
|------|------|------|----------|
| theory-update-summary-v6.1.21.md | 理论更新摘要 | 13,088 bytes | ~/claude-heartflow-skill/ |
| self-evolution-state-v6.1.21.md | 自我进化状态 | 11,167 bytes | ~/claude-heartflow-skill/ |
| UPGRADE_COMPLETE_v6.1.21.md | 升级完成 | 6,921 bytes | ~/claude-heartflow-skill/ |
| upgrade-report-v6.1.21-cron.md | Cron 报告 | ~8,000 bytes | ~/claude-heartflow-skill/ |
