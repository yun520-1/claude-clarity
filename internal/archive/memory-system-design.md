...
```json
{
  ...
  "command": ["node", "~/.jvs/.openclaw/workspace/claude-heartflow-skill/scripts/daily-memory-extraction.js"]
}
```
...
**Command**:
```bash
node ~/.jvs/.openclaw/workspace/claude-heartflow-skill/scripts/memory-weekly-review.js
```
