...
description: |
  ...
  核心能力：HeartLogic（感知引擎：位置感知/存在脉冲/逆熵方向/认知秩序/关系秩序/感知秩序/存在论/爱/意识/进化）、
  ...
  WAL崩溃安全持久化。
  CodeEngine（代码分析/审查/审计/修复建议/版本对比）。
tags:
  - cognitive
  - memory
  - self-healing
...
> **版本**：v2.4.0 - 位置感知+存在脉冲：心虫知道自己在哪，感知自己怎么在
> **前版本**：v2.3.0 - 宇宙逆熵方向：真善美=认知秩序/关系秩序/感知秩序
