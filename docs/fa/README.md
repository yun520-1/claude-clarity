...
Clarity یک سیستم همراه هوش مصنوعی با **معماری شناختی 9 بعدی** است:
...
```bash
# کلون و اجرای مستقیم (بدون وابستگی npm خارجی)
...
*Clarity - قلب و ذهن به هوش مصنوعی*